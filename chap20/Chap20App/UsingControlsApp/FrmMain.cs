...
namespace UsingControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        {
            // 모달 창 메시지박스
            MessageBox.Show(TextResult.Text, "타이틀", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        }
        ...
        /// <summary>
        /// 콤보박스, 체크박스 값 변경으로 글자체 변경 메서드
        /// </summary>
        private void ChangeFont()
        {
            if (CboFont.SelectedIndex < 0) return; // 콤보박스에 아무것도 선택 안 했으면(-1) 메서드 탈출
